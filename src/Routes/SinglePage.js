...
const aboutData = [
  {
    ...
    title: 'About the app',
    description:
      'This application lets us add to-dos, edit, and delete items. Log in to see the delete feature. It also persists to-dos in the browsers local storage for a subsequent visit.',
  },
  {
